        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href={`/${locale}/ai-generator`} className="text-gray-400 hover:text-white transition-colors">
                  {t('links.aiGenerator')}
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href={`/${locale}/portfolio`} className="text-gray-400 hover:text-white transition-colors">
                  {tNav('portfolio')}
                </Link>
              </li>
              <li>
